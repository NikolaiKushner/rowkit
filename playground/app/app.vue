...
<template>
  <div class="min-h-screen bg-background px-6 py-10 text-text">
    <div class="mx-auto flex max-w-xl flex-col gap-6">
      ...
      <section class="flex flex-col gap-3">
        <h2 class="text-sm font-medium uppercase tracking-wide text-text-muted">Status badges</h2>
        <div class="flex flex-wrap items-center gap-2">
          <Badge variant="success" dot>Active</Badge>
          <Badge variant="warning" dot>Invited</Badge>
          <Badge variant="danger" dot>Suspended</Badge>
          <Badge variant="neutral">Archived</Badge>
          <Badge variant="primary" appearance="solid">Owner</Badge>
        </div>
      </section>
    </div>
  </div>
